...
Um projeto com o codinome *All For One* em que praticará diversos conceitos de SQL. Porém, você vai usar um banco de dados totalmente diferente, `Northwind`, que será usado neste projeto. As instruções de como restaurar o banco podem ser lidas a seguir.
